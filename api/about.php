...
<body>
            ...
            <div class="row">
                <div class="col-xxl-9 col-xl-9 col-lg-12 col-md-12 col-sm-12">
                    <h2>
                        ...
                        Ho maturato la mia esperienza professionale prevalentemente nel settore della moda e del graphic
                        design. Questo percorso mi ha permesso di sviluppare una spiccata sensibilità estetica e un
                        approccio versatile, con una particolare attenzione ai dettagli.
                        <br><br>
                        Amo esplorare tutto ciò che ruota attorno al linguaggio visivo, ricercando e sperimentando
                        costantemente le novità che il futuro propone, per rimanere al passo con l'evoluzione del
                        settore.
                        Nei miei lavori prediligo un design d'impatto, vivace e ricco di dettagli, ma so adattarmi alle
                        esigenze del progetto, creando anche soluzioni più minimaliste e raffinate, quando richiesto.
                        <br><br>
                        Trovo che un buon design si basi soprattutto sull'intento che si vuole raggiungere. Infatti, lo
                        stile deve sempre adattarsi agli obiettivi del progetto per creare l'atmosfera giusta e
                        raccontare una storia visivamente efficace.
                    </h2>
                </div>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-xxl-4 col-xl-6 col-lg-5 col-md-8 col-sm-12">
                        <p>
                            Centro scolastico per le industrie artistiche (CSIA). <br>
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-xxl-4 col-xl-6 col-lg-5 col-md-8 col-sm-12">
                        <p>
                            Scuola specializzata superiore di tecnica dell'abbigliamento (SSSTA). <br>
                            Tecnico dipl. SSS tessile, moda e tecnologia; Indirizzo moda in progettazione e collezione.
                            <br>
                            Attestato TicinoModa per il miglior diploma (2019).
                        </p>
                    </div>
                </div>
                <div class="row mt-3">
                    ...
                    <div class="col-xxl-4 col-xl-6 col-lg-5 col-md-8 col-sm-12">
                        <p>
                            Scuola d'arti e mestieri della sartoria (SAMS). <br>
    ...
    <section id="About-library">
        <div class="container-fluid">
            <div class="row">
                <div class="col">
                    <h2 class="mt-5 mb-3">Una fonte d'ispirazione</h2>
                    <div class="row mt-3">
                        <div class="col-xxl-6 col-xl-7 col-lg-8 col-md-9 col-sm-12">
                            <h3>Da sempre avida lettrice, oltre alla formazione accademica ho approfondito le mie conoscenze attraverso una selezione di libri che hanno arricchito il mio percorso professionale.</h3>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row mt-3">
                <div class="bookshelf">
                    ...
                    <div class="book" data-title="Poses for Fashion Illustration" data-author="Womens Edition"
                        ...
                        data-height-cm="16" data-width-cm="7.2"></div>
                </div>

                <!-- tooltipLibrary per mostrare dettagli libro -->
                <div id="tooltipLibrary" class="tooltipLibrary"></div>
            </div>
        </div>
    </section>
    <div class="container-fluid">
